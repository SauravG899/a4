...
const bodyWashProducts = getProductsByCategory("Body Wash")
...
export default function BodyWashPage() {
  return (
      ...
      <main className="px-8 py-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-4xl font-bold text-black mb-2">BODY WASH</h1>
              <p className="text-lg text-gray-700">Luxurious body cleansers for every skin type and preference</p>
            </div>
