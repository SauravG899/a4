...
const faceWashProducts = getProductsByCategory("Face Wash")
      ...
      <main className="px-8 py-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-4xl font-bold text-black mb-2">FACE WASH</h1>
              <p className="text-lg text-gray-700">Gentle yet effective cleansers for every skin type and concern</p>
            </div>
